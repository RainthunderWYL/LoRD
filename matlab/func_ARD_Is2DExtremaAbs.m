function Is2DExtrema = func_ARD_Is2DExtremaAbs(...
                                R0,Tinv,DataThres, x1,x2,x3,data_thres)
...
DT_1m20 = interp3(X1,X2,X3,data_thres,R_1m20.e1,R_1m20.e2,R_1m20.e3,'linear');
DT_1p20 = interp3(X1,X2,X3,data_thres,R_1p20.e1,R_1p20.e2,R_1p20.e3,'linear');
DT_102m = interp3(X1,X2,X3,data_thres,R_102m.e1,R_102m.e2,R_102m.e3,'linear');
DT_102p = interp3(X1,X2,X3,data_thres,R_102p.e1,R_102p.e2,R_102p.e3,'linear');
% DT_1m2m = interp3(X1,X2,X3,data_thres,R_1m2m.e1,R_1m2m.e2,R_1m2m.e3,'linear');
% DT_1p2p = interp3(X1,X2,X3,data_thres,R_1p2p.e1,R_1p2p.e2,R_1p2p.e3,'linear');
% DT_1m2p = interp3(X1,X2,X3,data_thres,R_1m2p.e1,R_1m2p.e2,R_1m2p.e3,'linear');
% DT_1p2m = interp3(X1,X2,X3,data_thres,R_1p2m.e1,R_1p2m.e2,R_1p2m.e3,'linear');
...
Is2DExtrema = DataThres>DT_1m20 & DataThres>DT_1p20 & ...
    DataThres>DT_102m & DataThres>DT_102p;
end